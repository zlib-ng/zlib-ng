...
elseif("${ARCH}" MATCHES "(avr|xtensa|generic|unrecognized|unknown)")
    set(BASEARCH "generic")
    set(BASEARCH_GENERIC_FOUND TRUE)
    set(ARCH_BITS 32)
else()
    set(BASEARCH "generic")
    set(BASEARCH_GENERIC_FOUND TRUE)
    set(ARCH_BITS 32)
    message(STATUS "Basearch '${ARCH}' not recognized, defaulting to 'generic'.")
endif()
