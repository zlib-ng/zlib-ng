...
#  define LONGEST_MATCH_SLOW longest_match_slow_unaligned_16
#  ifdef HAVE_BUILTIN_CTZ
extern uint32_t longest_match_slow_unaligned_32(deflate_state *const s, Pos cur_match);
#    undef LONGEST_MATCH_SLOW
#    define LONGEST_MATCH_SLOW longest_match_slow_unaligned_32
#  endif
#  if defined(UNALIGNED64_OK) && defined(HAVE_BUILTIN_CTZLL)
extern uint32_t longest_match_slow_unaligned_64(deflate_state *const s, Pos cur_match);
#    undef LONGEST_MATCH_SLOW
#    define LONGEST_MATCH_SLOW longest_match_slow_unaligned_64
#  endif
#endif
...
#  undef LONGEST_MATCH_SLOW
#  define LONGEST_MATCH_SLOW longest_match_slow_neon
#endif
#ifdef POWER9
extern uint32_t longest_match_slow_power9(deflate_state *const s, Pos cur_match);
#  undef LONGEST_MATCH_SLOW
#  define LONGEST_MATCH_SLOW longest_match_slow_power9
#endif
#ifdef RISCV_RVV
extern uint32_t longest_match_slow_rvv(deflate_state *const s, Pos cur_match);
#  undef LONGEST_MATCH_SLOW
#  define LONGEST_MATCH_SLOW longest_match_slow_rvv
#endif
#if defined(X86_SSE2) && defined(HAVE_BUILTIN_CTZ)
extern uint32_t longest_match_slow_sse2(deflate_state *const s, Pos cur_match);
#  undef LONGEST_MATCH_SLOW
#define LONGEST_MATCH_SLOW longest_match_slow_sse2
#endif
#if defined(X86_AVX2) && defined(HAVE_BUILTIN_CTZ)
extern uint32_t longest_match_slow_avx2(deflate_state *const s, Pos cur_match);
#  undef LONGEST_MATCH_SLOW
#  define LONGEST_MATCH_SLOW longest_match_slow_avx2
#endif

#ifndef HAVE_NATIVE_INSTRUCTIONS
#  include "functable.h"
#  undef LONGEST_MATCH
#  define LONGEST_MATCH functable.longest_match
#  undef LONGEST_MATCH_SLOW
#  define LONGEST_MATCH_SLOW functable.longest_match_slow
#endif
